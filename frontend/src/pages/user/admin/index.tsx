...
const Admin = () => {
  ...
  if (!adminInfo) {
    ...
    return (
      <Row
        style={{ width: '100%', padding: '0', margin: '0', flexGrow: 1 }}
      ...
      >
        ...
        <Col xs={12} style={{ padding: '0', flexGrow: 1, display: 'flex' }}>
          <Row style={{ padding: '0', margin: '0', width: '100%', flexGrow: 1 }}>
            ...
            <Col
              ...
              md={9}
              lg={10}
              style={{ padding: '1% 5% 0% 5%', flexGrow: 1, display: 'flex' }}
            >
              <Outlet />
            </Col>
          </Row>
